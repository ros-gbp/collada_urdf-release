## collada_urdf (kinetic) - 1.12.13-1

The packages in the `collada_urdf` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --rosdistro kinetic collada_urdf` on `Tue, 14 Jul 2020 17:48:00 -0000`
...
## collada_urdf (melodic) - 1.12.12-0

The packages in the `collada_urdf` repository were released into the `melodic` distro by running `/usr/bin/bloom-release collada_urdf --track melodic --rosdistro melodic` on `Tue, 08 May 2018 13:47:06 -0000`
...
## collada_urdf (lunar) - 1.12.12-0

The packages in the `collada_urdf` repository were released into the `lunar` distro by running `/usr/bin/bloom-release collada_urdf --track lunar --rosdistro lunar` on `Tue, 08 May 2018 13:44:47 -0000`
...
## collada_urdf (kinetic) - 1.12.12-0

The packages in the `collada_urdf` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release collada_urdf --track kinetic --rosdistro kinetic` on `Tue, 08 May 2018 13:42:34 -0000`
...
## collada_urdf (melodic) - 1.12.11-0

The packages in the `collada_urdf` repository were released into the `melodic` distro by running `/usr/bin/bloom-release collada_urdf --track melodic --rosdistro melodic` on `Tue, 17 Apr 2018 14:54:34 -0000`
...
## collada_urdf (lunar) - 1.12.10-2

The packages in the `collada_urdf` repository were released into the `lunar` distro by running `/usr/bin/bloom-release collada_urdf --track lunar --rosdistro lunar` on `Tue, 27 Jun 2017 22:08:31 -0000`
